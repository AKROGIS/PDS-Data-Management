...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "AKR_BLDG_PY",
    "Location_BuildingFootprint_Relation",
    "SIMPLE",
    "Building Footprints",
    "FMSS Location Record",
    "NONE",
    "ONE_TO_MANY",
    "NONE",
    "Location",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "ROADS_FEATURE_PT",
    "Location_RoadFeatures_Relation",
    "SIMPLE",
    "Road Features",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "TRAILS_FEATURE_PT",
    "Location_TrailFeatures_Relation",
    "SIMPLE",
    "Trail Features",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "AKR_ASSET_PT",
    "Location_PointAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "AKR_ASSET_LN",
    "Location_LineAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "AKR_ASSET_PY",
    "Location_PolyAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport_Asset",
    "AKR_ASSET_PT",
    "Asset_PointAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Asset Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport_Asset",
    "AKR_ASSET_LN",
    "Asset_LineAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Asset Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport_Asset",
    "AKR_ASSET_PY",
    "Asset_PolyAssetFeatures_Relation",
    "SIMPLE",
    "Facility Assets",
    "FMSS Asset Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport_Asset",
    "TRAILS_ATTRIBUTE_PT",
    "Asset_TrailAttributes_Relation",
    "SIMPLE",
    "Trail Attributes",
    "FMSS Asset Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_BLDG_PT",
    "AKR_BLDG_PY",
    "BuildingCenter_Footprint_Relation",
    "SIMPLE",
    "Footprints",
    "Centroid",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport",
    "AKR_ATTACH_PT",
    "Location_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "FMSS Location Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "FMSSExport_Asset",
    "AKR_ATTACH_PT",
    "Asset_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "FMSS Asset Record",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_BLDG_PT",
    "AKR_ATTACH",
    "BuildingPoint_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Building Point",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_BLDG_PY",
    "AKR_ATTACH",
    "BuildingPoly_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Building Poly",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "PARKLOTS_PY",
    "AKR_ATTACH",
    "ParkingLot_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Parking Lot",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "TRAILS_FEATURE_PT",
    "AKR_ATTACH",
    "TrailFeature_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Trail Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "ROADS_FEATURE_PT",
    "AKR_ATTACH",
    "RoadFeature_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Road Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_PT",
    "AKR_ATTACH",
    "MiscPointFeatures_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Misc Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_LN",
    "AKR_ATTACH",
    "MiscLineFeatures_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Misc Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_PY",
    "AKR_ATTACH",
    "MiscPolyFeatures_Attachment_Relation",
    "SIMPLE",
    "Photos",
    "Misc Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_BLDG_PT",
    "AKR_ATTACH_PT",
    "BuildingPoint_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Building Point",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_BLDG_PY",
    "AKR_ATTACH_PT",
    "BuildingPoly_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Building Poly",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "PARKLOTS_PY",
    "AKR_ATTACH_PT",
    "ParkingLot_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Parking Lot",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "TRAILS_LN",
    "AKR_ATTACH_PT",
    "Trail_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Trail",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "TRAILS_FEATURE_PT",
    "AKR_ATTACH_PT",
    "TrailFeature_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Trail Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "ROADS_FEATURE_PT",
    "AKR_ATTACH_PT",
    "RoadFeature_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Road Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_PT",
    "AKR_ATTACH_PT",
    "MiscPointFeatures_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Misc Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_LN",
    "AKR_ATTACH_PT",
    "MiscLineFeatures_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Misc Feature",
    "NONE",
...
arcpy.CreateRelationshipClass_management(
    "AKR_ASSET_PY",
    "AKR_ATTACH_PT",
    "MiscPolyFeatures_AttachmentPoint_Relation",
    "SIMPLE",
    "GeoPhotos",
    "Misc Feature",
    "NONE",
