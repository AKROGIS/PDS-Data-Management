...
# Copy as a feature classs
#          'Building_Photo_Points',

        log.info("Geodatabase being copied: %s -- Feature Count: %s" %(dbConnection, len(allDbData)))

        for targetName in allDbData:
            # targetName = sourcePath   # .split('.')[-1]
            sourcePath = 'akr_facility.gis.' + targetName
...
if __name__ == "__main__":
    ...
    targetGDB = r"c:\tmp\fmss\akr_facility_new2.gdb"   # must be a full path
