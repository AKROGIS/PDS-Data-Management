...
def check_folder(folder, ext, outputter=None):
    """Output file name and size for files with extension ext below folder."""
...
if __name__ == "__main__":
    ...
    # main('Y:\\Extras\\AKR\\Statewide\\Imagery\\SDMI_SPOT5', 'tif',
    #      'data/spot_images_y.csv')  # Duplicate of Z:\SPOT5
    # IFSAR
    # main('X:\\SDMI\\IFSAR', '.tif') #, 'data/ifsar_images_x.csv')  # Subset of Z:\IFSAR
    # main('Z:\\IFSAR', '.tif', 'data/ifsar_images_z.csv')
    # main('Y:\\Extras\\AKR\\Statewide\\DEM\\SDMI_IFSAR', '.tif',
    #      'data/spot_images_y.csv')  # Duplicate of Z:\IFSAR
    # IKONOS
    # main(r'X:\IKONOS\LACL\BGRN', '.tif')
    # main(r'X:\Extras\AKR\Statewide\DEM\SDMI_IFSAR', '.bil',
    #      'c:/Users/RESarwas/Documents/GitHub/pds-reorg/data/ifsar_bil_new_x.csv')
    main(
