...
print(
    "Check grandparent folder: Always gets check right (one other broken layer found)."
)
# ****
...
print(
    "Check great-grandparent folder, Always fails, unless basemap folder checked first"
)
